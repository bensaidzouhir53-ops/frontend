...
const BADGES = [
  ...
  {
    icon: Truck,
    title: 'توصيل لجميع مناطق المملكة',
    desc: 'شحن سريع وموثوق',
    color: 'text-teal',
    bg: 'bg-teal/10',
  },
  {
    icon: Phone,
    title: 'دعم عملاء باللغة العربية',
    desc: 'فريقنا جاهز لمساعدتك',
    color: 'text-teal',
    bg: 'bg-teal/10',
  },
  {
    icon: RotateCcw,
    title: 'إرجاع مجاني خلال 7 أيام',
    desc: 'ضمان الرضا التام',
    color: 'text-gold',
    bg: 'bg-gold/10',
  },
  {
    icon: Leaf,
    title: 'مكونات عشبية طبيعية',
    desc: 'خالية من الإضافات الاصطناعية',
