          ...
          <div className="max-w-sm">
            ...
            {isSafePage ? (
              <p className="text-base font-medium leading-relaxed text-mist/70 md:text-lg">
                نسمة متجر إلكتروني سعودي يركز على تجربة طلب واضحة، دعم عملاء متجاوب، وتوصيل داخل
                المملكة بالدفع عند الاستلام.
              </p>
            ) : (
              <p className="text-base font-medium leading-relaxed text-mist/70 md:text-lg">
                نسمة هي أول صيدلية سعودية متخصصة في العناية بالجهاز التنفسي. بخاخات وقطرات عشبية
                بمعايير صيدلانية، مطابقة لمواصفات هيئة الغذاء والدواء (SFDA)، تعتني برئتيك
                وجيوبك الأنفية في ظروف السعودية: غبار، مكيفات، شيشة، وغبار الدوام.
              </p>
            )}
          </div>
