...
export interface ProductPageSections {
  ...
  reviewsKey: 'herbal-lung-spray' | 'molien-drops' | 'molien-drops-women'
...
const MOLIEN_DROPS_WOMEN_SECTIONS: ProductPageSections = {
  ...MOLIEN_DROPS_SECTIONS,
  painAlert: 'تنبيه للسيدات: صدركِ يصرخ — وانتِ تتجاهلينه؟ ⚠️',
  painTitle: 'كحة، بلغم، وكتمة؟ رئتكِ محتاجة تنظيف من جوّا — مو مسكنات!',
  painBody:
    'مع الغبار بالرياض، بخور البيت، والمكيف في المكتب — كلها تتراكم برئتكِ وتقطع نفسكِ. مو أول مرة تحسين بثقل بصدركِ.. بس أول مرة تلقين حل ينظّف وما يغطّي. قطرات المولين من نَفَس تعطيكِ تنظيف طبيعي 100% من جوّا، بدون كيماويات ولا تعب. لا تخلي الكتمة والبلغم يسيطرون على يومكِ!',
  painPoints: [
    { text: 'تصحين الفجر وبلغم ثقيل يضايقكِ — وكل يوم نفس المعاناة؟' },
    { text: 'تحسين بكتمة بالليل وما تقدرين تاخذين نفسكِ كامل مع الغبار والحر؟' },
    { text: 'ريحة البخور والعود تضايق صدركِ — وتبي حل طبيعي يريّحكِ؟' },
  ],
  painImageAlt: 'سيدة تعاني من كتمة والبلغم',
  painOverlay: 'لا تخلي الكتمة والبلغم يسيطرون على يومكِ',
  agitation: {
    ...MOLIEN_DROPS_SECTIONS.agitation!,
    alert: 'لا تكابري.. صدركِ جالس ينهار من جوّا وأنتِ تسلّين لنفسكِ! ⏳',
    title: 'تحسبينها مجرد "كحة وتروح"؟ هذا اللي ينتظركِ إذا ما نظفتِ رئتكِ اليوم!',
    body: 'كل يوم تتجاهلين فيه البلغم والكتمة، أنتِ جالسة تبنين جدار من السموم داخل رئتكِ. الغبار، البخور، الدخان، وحتى هوا المكيف.. كلها قاعدة تسد مجاري التنفس ببطء. لا تستنين لين يوصل فيكِ الحال إنكِ ما تقدرين تطلعين درج بيتكِ!',
    points: [
      { text: 'بعد كم شهر: كحتكِ بتزيد وتفضحكِ بالدوام والمجالس، وصوت صفير صدركِ بيحرمكِ النوم.' },
      { text: 'بعد سنة: البلغم بيتحجر أكثر، ومناعتكِ بتقل، وبتصيرين تلهثين من أقل مجهود.' },
      { text: 'بعد فترة: بتصيرين ضيفة دايمة في الطوارئ تدورين أكسجين عشان بس تاخذين "نفس طبيعي"!' },
    ],
    overlay: 'لا تستنين لين يوصل فيكِ الحال كذا.. نظّفي رئتكِ اليوم!',
  },
  solutionTitle: 'ينظّف الرئة من جوّا — مو يغطّي على المشكلة',
  solutionBody:
    'العسل والبخار يعطونكِ راحة ساعة.. المولين يشتغل على صدركِ كل يوم. عكس الحلول المؤقتة، خلاصة المولين المركّزة تشتغل على تطهير الشعب الهوائية، تهدّي الكحة، وتفكّ البلغم — طبيعي 100% ومناسب للاستخدام اليومي مع جو السعودية.',
  solutionImageAlt: 'قطرات المولين للسيدات — تركيبة عشبية مركّزة لإذابة البلغم',
  solutionFeatures: [
    { title: 'يفتح صدركِ ويخلي التنفس أسهل من أول أيام' },
    { title: 'يفكّ الكتمة ويطرد البلغم المزعج' },
    { title: 'ينظّف الرئة من آثار الغبار والبخور والمكيف' },
    { title: 'يعزّز مناعتكِ — مو بس يريّحكِ ساعة ويخلّص' },
  ],
  mechanismTitle: 'آلية العمل — 3 خطوات وصدركِ يفتح 💧',
  mechanismSteps: [
    {
      step: 1,
      title: 'تطهير الشعب الهوائية',
      desc: 'بقطرات بسيطة، تتغلغل خلاصة المولين وتنظّف الممرات التنفسية من الشوائب — آثار الغبار، البخور، والمكيف اللي يخنقكِ كل يوم.',
    },
    {
      step: 2,
      title: 'تفكيك البلغم وتهدئة الكحة',
      desc: 'تذوّب البلغم المتراكم وتفكّ الكتمة اللي تضايقكِ — مو راحة ساعة، لا.. صدركِ يفتح وتتنفسين براحة.',
    },
    {
      step: 3,
      title: 'تعزيز المناعة وحماية الرئة',
      desc: 'مضادات أكسدة طبيعية تحمي خلايا رئتكِ وتقلّل الالتهاب — عشان ترجعين تتنفسين بحرية مو بكتمة.',
    },
  ],
  statsSection: {
    ...MOLIEN_DROPS_SECTIONS.statsSection!,
    title: 'ينفع لكل السيدات اللي يعانين من مشاكل التنفس',
    subtitle:
      'خصوصاً مع الغبار والمكيف والبخور! راح تحبين شعور التنفس العميق من جديد — ودّعي كتمة الصدر اللي تضايقكِ كل ليلة.',
    imageAlt: 'سيدة سعودية تتنفس براحة مع رئتين سليمتين',
    imageCaption: '«أخيراً صرت أصحى بدون البلغم ناشب — قطرات المولين غيّرت تنفسي»',
  },
  howToUseSubtitle:
    'تركيبتنا مركّزة — كل اللي تحتاجينه من 2 إلى 3 قطرات بس! استخدميها مرتين يومياً — صباحاً ومساءً — ولا تنسين الالتزام عشان تشوفين الفرق.',
  howToUseSteps: [
    {
      step: 1,
      title: 'تحت اللسان مباشرة',
      desc: 'حطّي من 2 إلى 3 قطرات تحت لسانكِ واتركيها تمتص — أسرع طريقة لامتصاص مستخلص المولين.',
      image: '/images/molien-howto-under-tongue.svg',
      video: '/videos/molien-howto-under-tongue.mp4',
    },
    {
      step: 2,
      title: 'مع كوب ماء دافئ',
      desc: 'أضيفي من 2 إلى 3 قطرات في نص كوب ماء دافئ واشربيها — مناسبة إذا تفضّلين طريقة أخف على الحلق.',
      image: '/images/molien-howto-glass-water.svg',
      video: '/videos/molien-howto-glass-water.mp4',
    },
  ],
  comparisonRows: [
    { feature: 'المفعول والنتيجة', us: 'تنظّف الرئة من جوّا، تفكّ الكتمة، وتعطيكِ نَفَس عميق ومريح طول اليوم.', them: 'تريّحكِ ساعة.. وترجع لكِ الكتمة والضيقة (العسل والزنجبيل)' },
    { feature: 'التحضير والوقت', us: 'جاهزة بجيبكِ! قطرات سريعة تاخذينها بأي وقت وبأي مكان بدون قروشة.', them: 'حوسة، وتعب بالتحضير، ومفعولها يروح بسرعة (البخار والمشروبات)' },
    { feature: 'التركيبة والتركيز', us: 'خلاصة عشبة المولين المركّزة، تطرد السموم والبلغم وتصفي صدركِ صح.', them: 'سكر ونكهات على الفاضي، مجرد تسكين مؤقت (حلاو الحلق العادي)' },
    { feature: 'الترخيص والأمان', us: 'مصرّحة من هيئة الغذاء والدواء السعودية (SFDA).. تطمّني واستخدميها وأنتِ مرتاحة.', them: 'مجهولة المصدر وما تدري وش مكوناتها (المنتجات العشوائية)' },
    { feature: 'الضمان', us: 'ضمان ذهبي 30 يوم (استرداد كامل بدون قروشة)', them: 'تدفعين وتخاطرين بفلوسكِ بدون أي ضمان' },
  ],
  dayProcess: {
    ...MOLIEN_DROPS_SECTIONS.dayProcess,
    imageAlt: 'سيدة سعودية تشعر بالراحة بعد استخدام قطرة المولين',
    overlayTitle: 'لكل سيدة تبي ترتاح صدرها وتتنفسين هواء نظيف',
    overlayDesc:
      'روتين يومي لكل امرأة تبي تحافظ على رئتها من الغبار، البخور، والمكيف.',
  },
  beforeAfterComparison: {
    ...MOLIEN_DROPS_SECTIONS.beforeAfterComparison!,
    beforeAlt: 'سيدة تعاني من كحة وكتمة في الصدر قبل استخدام قطرات المولين',
    afterAlt: 'سيدة تتنفس براحة وصدرها مرتاح بعد استخدام قطرات المولين',
  },
  trustOrigin: {
    ...MOLIEN_DROPS_SECTIONS.trustOrigin!,
    title: 'من بلدنا — استخدميه وأنتِ مطمئنة 🇸🇦',
    body:
      'جودة تثقين فيها لصدركِ ورئتكِ — ولا تنتظرين لين تتفاقم الكتمة. كل دفعة تمر بفحص مخبري قبل ما توصلكِ، وكل مكون اخترناه بناءً على دراسات تثبت فعاليته في توسيع الشعب الهوائية وطرد السموم.',
    points: MOLIEN_DROPS_SECTIONS.trustOrigin!.points.map((point) =>
      point.title === 'معتمد SFDA'
        ? {
            ...point,
            desc: 'تركيبة آمنة ومطابقة لمعايير هيئة الغذاء والدواء السعودية — استخدميها وأنتِ مطمئنة.',
          }
        : point,
    ),
  },
  imageReviewsSection: {
    title: 'شوف وش تقول السيدات بعد ما جربن قطرات المولين 💬',
    subtitle:
      'تجارب موثقة من سيدات بالرياض وجدة والدمام — جربن قطرات المولين وشافين الفرق بأنفسهن.',
  },
  reviewsKey: 'molien-drops-women',
  sfdaCertificateSection: {
    ...MOLIEN_DROPS_SECTIONS.sfdaCertificateSection!,
    subtitle:
      'منتجنا مسجّل رسمياً لدى الهيئة العامة للغذاء والدواء — مستخلص ورق المولين معتمد كمكمل غذائي. استخدميه وأنتِ مطمئنة.',
  },
}
...
const PRODUCT_PAGE_SECTIONS: Record<string, ProductPageSections> = {
  ...
  'molien-drops-women': MOLIEN_DROPS_WOMEN_SECTIONS,
}
