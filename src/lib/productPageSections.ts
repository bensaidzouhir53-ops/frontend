...
const HERBAL_LUNG_SPRAY_RESULTS_PHASES: DayProcessPhase[] = [
  {
    period: 'من أول استخدام',
    title: 'تنفس مريح فوراً',
    benefits: [
      'تحس صدرك ينفك من ثقل الكتمة من أول بخات',
      'تاخذ نفس عميق بدون ما تلهث أو تكح — فرق تحسه من اليوم الأول',
    ],
    stat: '95% حسوا بانتعاش فوري وخفة بالصدر من أول استخدام',
  },
  {
    period: 'بعد أسبوع',
    title: 'صدر أنظف وبلغم أقل',
    benefits: [
      'الكحة الصباحية والبلغم الغثيث يبدأون يختفون تدريجياً',
      'تحس إن مجاري تنفسك صارت أوسع وصدرك أخف بكثير',
    ],
    stat: '91% لاحظوا إن صدرهم تخلص من البلغم خلال أول أسبوع',
  },
  {
    period: 'بعد أسبوعين',
    title: 'رجعت تتنفس بعمق',
    benefits: [
      'تنام ليل كامل بدون تصفير بصدرك أو كتمة تقطع نومك',
      'تطلع درج أو تمشي بدون ما تهن — تنفسك يرافقك طبيعي',
    ],
    stat: '88% رجعوا يتنفسون براحة كاملة كأنهم برئة جديدة',
  },
  {
    period: 'بعد 28 يوم',
    title: 'حياة جديدة وطاقة ترجع',
    benefits: [
      'نوم عميق، نشاط يومي، وثقة إنك تتحكم بتنفسك',
      'تنسى إن الكتمة والبلغم كانوا جزء من يومك — صدرك منشرح طول الوقت',
    ],
    stat: '85% أكدوا إن طاقتهم ونشاطهم اليومي تضاعف مع الاستمرار',
  },
]
