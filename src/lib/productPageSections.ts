...
import { buildMolienDropsWomenSections } from './molienDropsWomenSections'

const MOLIEN_DROPS_WOMEN_SECTIONS = buildMolienDropsWomenSections(MOLIEN_DROPS_SECTIONS)
