...
const MOLIEN_DROPS_SECTIONS: ProductPageSections = {
  ...
  painBody:
    'مع الغبار بالرياض، الشيشة بالجلسة، والمكيف بالدوام — كلها تتراكم برئتك وتقطع نفسك. مو أول مرة تحس بثقل بصدرك.. بس أول مرة تلقى حل ينظّف وما يغطّي. قطرات المولين من نسمة تعطيك تنظيف طبيعي 100% من جوّا، بدون كيماويات ولا تعب. لا تخلي الكتمة والبلغم يسيطرون على يومك!',
  painPoints: [
  ...
  statsSection: {
    ...
    footnote: '* بناءً على تقييمات عملاء نسمة — النتائج تختلف حسب الالتزام بالروتين اليومي.',
  },
  ...
  trustOrigin: {
    ...
    subtitle:
      'قطرات المولين من نسمة — تركيبة طبيعية مركّزة، تُصنَّع في السعودية ومعتمدة من هيئة الغذاء والدواء.',
    body:
