...
export const HERBAL_LUNG_SPRAY_OFFERS: Offer[] = [
  ...
  },
  {
    ...
    isDefault: true,
    savings: 93,
    desc: 'ليش أغلب السعوديين ياخذون هالخيار؟ 60 مل = شهر كامل بدون ما تفصل الروتين. من الأسبوع الثاني تحس إن البلغم الصباحي يقل والصدر ينشرح — وتوفر 93 ريال + شحن مجاني.',
  },
  {
    qty: 3,
    price: 325,
