...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    sku: 'MOILZOUH',
    nameAr: 'صدركِ مكتوم وبلغمكِ ما يوقف؟ قطرات المولين للسيدات تنظّف رئتكِ وتطرد بلغم السنين! 🌿',
    ...
    descAr:
      'الكحة اللي تفضحكِ بالمجالس، والبلغم اللي يحرجكِ الصبح بالدوام... ودّعيه للأبد! مع الغبار والبخور والمكيف، صدركِ جالس ينهار من جوّا. قطرات المولين من نَفَس تعطيكِ تنظيف طبيعي 100%، تفتح صدركِ، تفكّ الكتمة، وتطرد البلغم المزعج — عشان تتنفسين براحة من جديد.',
    image: '/images/molien-drops-hero.png',
    crossSells: ['herbal-lung-spray'],
    benefits: [
