...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    slug: 'molien-drops',
    sku: 'MOLIENDRP3',
    nameAr: 'تصحى كل صباح والغثا ناشب بحلقك؟ قطرة المولين تذوب البلغم المتحجر من أول يوم!',
    nameEn: 'Molien Drops — Dissolve Hardened Phlegm',
    cardTitleAr: 'قطرة المولين العشبية',
    shortDescAr: 'قطرات المولين العشبية لإذابة البلغم المتحجر وتخفيف الغثيان الصباحي من أول يوم',
    descAr:
      'قطرة المولين من نسمة مو مجرد قطرات عادية، هي الحل اللي تدور عليه إذا تصحى كل صباح والغثيان ناشب بحلقك! تركيبة عشبية مركّزة 100% من مستخلص المولين الطبيعي، مصممة خصيصاً لإذابة البلغم المتحجر اللي يجمع في حلقك وصدرك طول الليل. من أول يوم بتحس إن البلغم يلين ويطلع بسهولة، الغثيان الصباحي يخف، وحلقك يرجع مريح ونظيف. آمن تماماً وخالي من أي كيماويات، عشان تبدأ يومك بخفة وبدون عذاب.',
    image: '/images/molien-drops-hero.png',
    crossSells: ['herbal-lung-spray'],
    benefits: [
      'يذوب البلغم المتحجر من أول يوم',
      'يخلصك من الغثيان الصباحي والبلغم الناشب بحلقك',
      'يلين الحلق ويريح التهيج والكحة الصباحية',
      'طبيعي 100% ومصرح من الغذاء والدواء (SFDA)',
      'سهل الاستخدام — 15-20 قطرة مرتين يومياً',
    ],
    ingredients: [
    ...
    faqs: [
      ...
      { q: 'كيف طريقة الاستخدام؟', a: 'بسيطة: رج الزجاجة، وضع 15-20 قطرة تحت اللسان أو في كوب ماء دافئ. استخدمها مرتين يومياً (الصباح وقبل النوم) لأفضل نتيجة.' },
      { q: 'كيف يتم التوصيل والدفع؟', a: 'التوصيل سريع لجميع مناطق المملكة (2-4 أيام عمل). والأهم: الدفع عند الاستلام! تطلب الآن، ولما يوصلك المندوب وتستلم طلبك.. تدفع.' },
