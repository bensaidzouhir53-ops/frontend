...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    descAr:
      'مع الغبار والشيشة والمكيف — صدرك مو سليم! كحة، بلغم، وكتمة؟ رئتك محتاجة تنظيف من جوّا. مو أول مرة تحس بثقل بصدرك.. بس أول مرة تلقى حل ينظّف وما يغطّي. قطرات المولين من نسمة تعطيك تنظيف طبيعي 100% من جوّا، بدون كيماويات ولا تعب. تفتح صدرك، تفكّ الكتمة، وتطرد البلغم المزعج لتتنفس براحة من جديد.',
...
export const MOLIEN_DROPS_OFFERS: Offer[] = [
  ...
  },
  {
    ...
    price: 279,
    qtyLabel: 'عبوتين',
    volumeLabel: 'الأكثر طلباً',
    badge: 'تثبت النتيجة + شحن مجاني 🚚',
    badgeColor: 'gold',
    isDefault: true,
    savings: 99,
    desc: 'العبوتين تثبت النتيجة! روتين يكفيك شهرين لضمان تنظيف أعمق للرئة وتوفير 99 ريال.',
  },
  {
    qty: 3,
    price: 379,
    qtyLabel: '3 عبوات',
    volumeLabel: 'أفضل توفير',
    badge: 'وفر 188 ريال + شحن مجاني 🚚',
    badgeColor: 'teal',
    savings: 188,
    desc: 'لكل اللي يبي يتنفس براحة مستدامة! تغطيك 3 شهور، توفر 188 ريال، وتودع الكتمة للأبد.',
  },
]
