...
export const HERBAL_LUNG_SPRAY_OFFERS: Offer[] = [
  ...
  },
  {
    ...
    isDefault: true,
    savings: 93,
    desc: 'ليش أغلب السعوديين ياخذون هالخيار؟ 60 مل = شهرين كاملين بدون ما تفصل الروتين. من الأسبوع الثاني تحس إن البلغم الصباحي يقل والصدر ينشرح — وتوفر 93 ريال + شحن مجاني.',
  },
  {
    qty: 3,
    price: 325,
    ...
    badgeColor: 'teal',
    savings: 182,
    desc: 'لكل مدخن وكل واحد تعب من الكتمة! 90 مل تغطيك 3 شهور — الكورس اللي فعلاً يودع البلغم والكحة. وفّر 182 ريال ولا تخسر روتينك في نص الطريق.',
  },
]
