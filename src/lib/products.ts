...
export const HERBAL_LUNG_SPRAY_OFFERS: Offer[] = [
  {
    ...
    price: 169,
    qtyLabel: 'علبة واحدة',
    volumeLabel: '30 مل · شهر',
    ribbon: 'للتجربة السريعة',
    badge: 'بداية الراحة',
    badgeColor: 'sage',
    headline: 'تبي تشوف الفرق؟ ابدأ هنا — بس النتيجة الحقيقية تحتاج استمرار',
    desc: 'مناسب لو تبي تجرب بس. أغلب اللي حسّوا بفرق حقيقي كملوا شهرين على الأقل.',
    bullets: ['تكفيك شهر واحد', '169 ر.س للعبوة'],
  },
  {
    qty: 2,
    price: 229,
    qtyLabel: 'علبتان',
    volumeLabel: '60 مل · شهرين',
    ribbon: '🔥 87% من عملائنا يختارون هذا',
    badge: 'الأكثر طلباً',
    badgeColor: 'gold',
    isDefault: true,
    savings: 109,
    percentOff: 32,
    headline: 'الخيار الذكي — تثبّت النتيجة وما تقطع الروتين في نص الطريق',
    desc: 'من الأسبوع الثاني تحس إن البلغم الصباحي يقل والصدر ينشرح. هذي الباقة اللي يثبتون فيها أغلب السعوديين النتيجة.',
    bullets: ['شهرين كاملين بدون انقطاع', 'وفّر 109 ر.س مقارنة بشراء 2 منفردة', 'شحن مجاني + أولوية تجهيز'],
  },
  {
    qty: 3,
    price: 299,
    qtyLabel: '3 علب — الكورس الكامل',
    volumeLabel: '90 مل · 3 شهور',
    ribbon: '👑 أفضل قيمة — وفّر 208 ر.س',
    badge: 'أقل سعر للعبوة',
    badgeColor: 'apothecary',
    savings: 208,
    percentOff: 41,
    isBestValue: true,
    headline: 'الكورس اللي فعلاً يودّع الكتمة — 100 ر.س بس للعبوة!',
    desc: '3 شهور متواصلة = النتيجة اللي ما ترجع. اللي يكملون الكورس الكامل ما يندمون — وفّر 41% على كل عبوة.',
    bullets: ['كورس 3 شهور — النتيجة تثبت', '100 ر.س فقط للعبوة (أرخص خيار)', 'وفّر 208 ر.س — قيمة ما تتكرر'],
  },
]
...
export const MOLIEN_DROPS_OFFERS: Offer[] = [
  {
    ...
    price: 169,
    qtyLabel: 'علبة واحدة',
    volumeLabel: '60 مل · شهر',
    ribbon: 'للتجربة السريعة',
    badge: 'بداية التنظيف',
    badgeColor: 'sage',
    headline: 'تبي تشوف الفرق؟ ابدأ هنا — بس التنظيف العميق يحتاج استمرار',
    desc: 'مناسب للتجربة. أغلب اللي نظّفوا صدرهم فعلياً كملوا على الأقل شهرين.',
    bullets: ['تكفيك شهر واحد', '169 ر.س للعبوة'],
  },
  {
    qty: 2,
    ...
    savings: 109,
    percentOff: 32,
    headline: 'الخيار الذكي — تنظيف متواصل من جوّا بدون ما توقف',
    desc: 'شهرين كاملين تنظّف فيهم رئتك من ترسبات الدخان والغبار. هذي الباقة اللي يثبتون فيها أغلب عملائنا النتيجة.',
    bullets: ['شهرين تنظيف عميق متواصل', 'وفّر 109 ر.س مقارنة بشراء 2 منفردة', 'شحن مجاني + أولوية تجهيز'],
  },
  {
    qty: 3,
    price: 299,
    qtyLabel: '3 علب — الكورس الكامل',
    volumeLabel: '180 مل · 3 شهور',
    ribbon: '👑 أفضل قيمة — وفّر 208 ر.س',
    badge: 'أقل سعر للعبوة',
    badgeColor: 'apothecary',
    savings: 208,
    percentOff: 41,
    isBestValue: true,
    headline: 'الكورس الكامل — ودّع الكتمة للأبد بـ 100 ر.س للعبوة!',
    desc: '3 شهور = كورس كامل يطرد البلغم ويفكّ الكتمة من جذورها. أقل سعر للعبوة — وفّر 41% على كل وحدة.',
    bullets: ['كورس 3 شهور — نتيجة تثبت', '100 ر.س فقط للعبوة (أرخص خيار)', 'وفّر 208 ر.س — أفضل صفقة'],
  },
]
