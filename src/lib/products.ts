...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    ingredients: [
      'مستخلص المولين الطبيعي (مذيب للبلغم)',
      'مستخلص الزعتر (مطهر ومضاد للالتهاب)',
      'زيت النعناع الطبيعي (انتعاش وتهدئة)',
      'مستخلص البابونج (يريح الحلق المتهيج)',
    ],
    detailedIngredients: [
      {
        name: 'المولين',
        desc: 'العشبة الأساسية اللي تذوب البلغم المتحجر وتليّنه، تشتغل من أول يوم على تفكيك التراكمات اللي ناشبة بحلقك كل صباح.',
        image: '/images/ingredient-eucalyptus.png',
      },
      {
        name: 'الزعتر',
        desc: 'مطهر طبيعي يهدي التهيج في الحلق والصدر، ويساعد على طرد البلغم بسهولة بدون كحة مزعجة.',
        image: '/images/ingredient-hamamelis.png',
      },
      {
        name: 'البابونج',
        desc: 'يريح الحلق المتهيج والملتهب، ويقلل الغثيان الصباحي اللي يخرب بداية يومك.',
        image: '/images/ingredient-elderflower.png',
      },
      {
        name: 'النعناع',
        desc: 'يعطيك إحساس انتعاش فوري ويهدئ الكحة، ويخلي حلقك مريح ونظيف طول اليوم.',
        image: '/images/ingredient-collagen.png',
      },
      {
        name: 'المرّ',
        desc: 'يخفف الاحتقان في الممرات التنفسية ويلين البلغم الكثيف اللي يجمع وقت النوم.',
        image: '/images/ingredient-hydrastis.png',
      },
      {
        name: 'العرقسوس',
        desc: 'يغلف الحلق بطبقة مريحة ويذوب البلغم المتحجر، خصوصاً اللي يناشب ويخنقك كل صباح.',
        image: '/images/ingredient-styrax.png',
      },
      {
        name: 'الزنجبيل',
        desc: 'يقلل الغثيان ويحفز طرد البلغم، ويعطيك إحساس دفء وخفة في الصدر من أول استخدام.',
        image: '/images/ingredient-gongjing-grass.png',
      },
    ],
    faqs: [
