...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    sku: 'MOILZOUH',
    nameAr: 'تكحين بالمجلس؟ بلغم الصبح يفضحك؟ قطرات المولين للسيدات تنظّف صدركِ من جوّا! 🌿',
    nameEn: 'Molien Drops for Women — Deep Lung Cleansing',
    cardTitleAr: 'قطرات المولين للسيدات',
    shortDescAr:
      'قطرات عشبية للسيدات — تنظّف رئتكِ من الغبار والبخور والمكيف، وتخلّيكِ تاخذين نَفَس عميق من أول 3 أيام.',
    descAr:
      'الكحة اللي تفضحكِ بالمجلس، والبلغم اللي يحرجكِ كل صباح قبل الدوام.. والكتمة اللي تخنقكِ مع المكيف والبخور — ودّعيها! قطرات المولين من نَفَس تنظّف رئتكِ من جوّا، تفكّ الكتمة، وتطرد البلغم — طبيعي 100% ومصرّح SFDA. 3 قطرات مرتين باليوم وصدركِ يرجع ينشرح.',
    image: '/images/molien-drops-women-hero.png',
    crossSells: ['herbal-lung-spray'],
    benefits: [
      'ينظّف الرئة من جوّا — الغبار، البخور، والمكيف ما عاد يخنقونكِ',
      'يفكّ الكتمة ويفتح صدركِ — تنفسين أعمق من أول أيام',
      'يذوّب البلغم ويطرده — مو بس يهدّي الكحة ساعة',
      '3 قطرات مرتين باليوم — بدون حوسة ولا طعم مزعج',
      'طبيعي 100% ومصرّح SFDA — تستخدمينه وأنتِ مطمئنة',
    ],
    ingredients: [
      'أوراق المولين (مذيب للبلغم)',
      'جذور الخطمى (ملطف للأغشية)',
    ...
    detailedIngredients: [
      {
        name: 'أوراق المولين',
        desc: 'تفكّ الكتمة وتفتح الشعب الهوائية — مزيل احتقان طبيعي يسهّل عليكِ التنفس، خصوصاً مع البخور والغبار.',
        image: '/images/ingredient-mullein-leaves.png',
      },
      {
        name: 'جذور الخطمى',
        desc: 'ملطّف قوي للحلق والصدر — يهدّي الكحة اللي تفضحكِ بالمجالس ويريّح تهيج الحلق.',
        image: '/images/ingredient-marshmallow-root.png',
      },
      {
        name: 'مستخلص البريلا',
        desc: 'مضاد طبيعي للالتهابات — يساعد مع حساسية الغبار والمكيف اللي تضايق كثير من السيدات.',
        image: '/images/ingredient-perilla.png',
      },
      {
        name: 'مستخلص الزنييون',
        desc: 'يفتح الشعب الهوائية المسدودة — يخلّصكِ من ضيق التنفس والكتمة اللي تجي بالليل.',
        image: '/images/ingredient-calendula.png',
      },
      {
        name: 'مستخلص الزعتر',
        desc: 'مطهر طبيعي وطارد للبلغم — ينظّف الرئة ويفتح المسالك عشان تتنفسين بعمق.',
        image: '/images/ingredient-thyme.png',
      },
      {
        name: 'مستخلص الأستراجالوس',
        desc: 'يدعم مناعتكِ ويقوّي جهازكِ التنفسي — عشان ما ترجعين للكحة كل موسm غبار.',
        image: '/images/ingredient-astragalus.png',
      },
      {
        name: 'مستخلص قشر البرتقال',
        desc: 'غني بمضادات الأكسدة — يدعم صحة رئتكِ ويخلي تنفسكِ أنعم وأسهل.',
        image: '/images/ingredient-orange-peel.png',
      },
    ],
    faqs: [
      {
        q: 'ينفع مع البخور والعود؟ صدركِ يضيق من ريحة البيت؟',
        a: 'أكيد! كثير من السيدات يعانين من كتمة بسبب البخور والعود. قطرات المولين تنظّف الرئة من جوّا وتفكّ الكتمة — مو بس تغطّي على الريحة.',
      },
      {
        q: 'بلغم الصبح يفضحني — متى أحس بالفرق؟',
        a: 'من أول 3 أيام كثير من السيدات حسّوا صدر أخف. والبلغم يبدأ يلين ويطلع بسهولة باليوم 4-7. التزمي 28 يوم عشان النتيجة تثبت.',
      },
      {
        q: 'فيه كيماويات؟ أقدر أستخدمه كل يوم؟',
        a: 'لا يا حبيبتي — طبيعي 100% ومصرّح SFDA. مناسب كروتين يومي: 2-3 قطرات صباح ومساء. ما فيه تعود ولا غثيان زي الأقراص.',
      },
      {
        q: 'كيف الطلب والتوصيل؟',
        a: 'تطلبين من الموقع، نوصلكِ 2-4 أيام لكل مناطق المملكة. الدفع عند الاستلام — ما تدفعين ولا ريال لين يوصلكِ الطرد.',
      },
      {
        q: 'جربتِ وما ناسبكِ — وش ضمانكِ؟',
        a: 'ضمان 30 يوم ذهبي. جربي العبوة كاملة — إذا ما حسيتِ بفرق بصدركِ، نرجع لكِ فلوسكِ كاملة بدون أسئلة.',
      },
      {
        q: 'ليه أخذ عبوتين مو عبوة وحدة؟',
        a: '87% من السيدات يختارون عبوتين — شهرين يثبّتون النتيجة. العبوة الوحدة للتجربة، بس اللي كملوا شهرين حسّوا فرق أكبر بكثير.',
      },
    ],
  },
]
...
export const HERBAL_LUNG_SPRAY_OFFERS: Offer[] = [
  ...
  },
  {
    ...
    cardSubtitle:
      'أقل سعر للعبوة (110 ر.س). اللي يكملون الكورس الكامل يودّعون الكتمة والبلغم للأبد.',
  },
]
...
export const MOLIEN_DROPS_WOMEN_OFFERS: Offer[] = MOLIEN_DROPS_OFFERS.map((offer) => ({
  ...offer,
  ...(offer.qty === 1
    ? {
        cardSubtitleLead: 'تكفيكِ شهر —',
        cardSubtitle:
          'مناسبة لو تبين تشوفين الفرق. بس اللي كملوا شهرين حسّوا تحسّن أكبر.',
      }
    : {}),
  ...(offer.qty === 2
    ? {
        cardSubtitleLead: '87% من السيدات يختارون هذا —',
        cardSubtitle:
          'شهرين يثبّتون النتيجة: البلغم يقل، الصدر ينشرح، والكحة ما ترجع بالمجالس.',
      }
    : {}),
  ...(offer.qty === 3
    ? {
        cardSubtitle:
          'أقل سعر للعبوة. اللي يكملن الكورس الكامل يودّعن الكتمة والبلغم.',
      }
    : {}),
}))
...
const OFFERS_BY_PRODUCT: Record<string, Offer[]> = {
  ...
  'molien-drops-women': MOLIEN_DROPS_WOMEN_OFFERS,
}
