...
export const PRODUCTS: Product[] = [
  {
    ...
    descAr:
      'عايش بـ "نصف نفس"؟ بخاخ نسمة العشبي هو طوق النجاة اللي راح ينتشلك من أزمة الكتمة والبلغم اللي مخربة يومك! بتركيبة طبيعية مركزة 100%، هالبخاخ يشتغل زي المكنسة لرئتك.. يفكك تراكمات الدخان، يذيب البلغم المتحجر، ويفتح مجاري التنفس المقفلة من أول بخة. تخيل تصحى الصبح بدون كحة ناشفة، وبدون بلغم غثيث، وتتنفس بعمق كأنك مولود من جديد! آمن تماماً، مصرح من هيئة الغذاء والدواء، ويضمن لك صدر منشرح وراحة تدوم طول اليوم.',
...
export const HERBAL_LUNG_SPRAY_OFFERS: Offer[] = [
  {
    ...
    badgeColor: 'sage',
    savings: 0,
    desc: 'يكفيك عشان تحس بصدمة الانتعاش وتشوف الفرق بعينك بتخفيف الكتمة والبلغم.',
  },
  {
    qty: 2,
    price: 245,
    badge: 'كورس تنظيف الرئة + شحن مجاني 🚚',
    badgeColor: 'gold',
    isDefault: true,
    savings: 93,
    desc: 'الأكثر طلباً! عبوتين تضمن لك تنظيف أعمق للصدر وطرد بلغم السنين (وفر 93 ريال).',
  },
  {
    qty: 3,
    price: 325,
    badge: 'كورس التعافي الشامل + شحن مجاني 🚚',
    badgeColor: 'teal',
    savings: 182,
    desc: 'أفضل قيمة! للي يبي يودع الكتمة تماماً ويرجع يتنفس كأنه مولود من جديد (وفر 182 ريال).',
  },
]
