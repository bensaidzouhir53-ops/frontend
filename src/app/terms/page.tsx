...
export const metadata: Metadata = {
  title: 'نسمة | الشروط والأحكام',
  description: 'الشروط والأحكام لاستخدام متجر نسمة وإتمام عمليات الشراء.',
}
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-sage/20 p-8 md:p-10 space-y-8 text-right">
            ...
            <div className="bg-mist rounded-xl p-5 border border-sage/20">
              <p className="text-charcoal/70 text-sm leading-relaxed">
                باستخدامك لموقع نسمة أو إتمامك لأي عملية شراء، فإنك توافق على الشروط والأحكام التالية. يُرجى قراءتها بعناية قبل تقديم طلبك.
              </p>
            </div>
            ...
            {[
              {
                ...
                items: [
                  'جميع مشتريات نسمة تتم بنظام الدفع عند الاستلام (COD) فقط. لا يُطلب منك أي دفع مسبق.',
              ...
              },
              {
                ...
                items: [
                  'نسمة مسؤولة عن جودة المنتجات المشحونة وتوصيلها في الحالة الموصوفة.',
                  'لا تتحمل نسمة مسؤولية أي تأثيرات تنتج عن الاستخدام الخاطئ أو غير الموصى به للمنتجات.',
