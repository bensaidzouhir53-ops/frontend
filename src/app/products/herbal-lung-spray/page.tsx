...
export const metadata: Metadata = {
  title: 'نسمة | بخاخ تنظيف الرئتين العشبي لتنفس مريح',
  description:
    'بخاخ تنظيف الرئتين العشبي من نسمة — تركيبة عشبية طبيعية لدعم راحة الجهاز التنفسي اليومية. الدفع عند الاستلام، توصيل لجميع مناطق المملكة.',
}
