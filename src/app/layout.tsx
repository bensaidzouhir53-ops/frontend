...
export const metadata: Metadata = {
  title: {
    default: 'نسمة | متجر عناية بالتنفس',
    template: '%s | نسمة',
  },
  description:
    'نسمة — متجر متخصص في منتجات العناية بالجهاز التنفسي. بخاخات وقطرات عشبية طبيعية لدعم إحساس التنفس المريح. توصيل لجميع مناطق المملكة العربية السعودية. الدفع عند الاستلام.',
  keywords: [
    'منتجات تنفس',
    'بخاخ عشبي',
    'تنظيف الرئتين',
  ...
  twitter: {
    ...
    title: 'نسمة | متجر عناية بالتنفس',
    description: 'منتجات عشبية طبيعية لدعم إحساس التنفس المريح.',
  },
  robots: {
    index: true,
    follow: true,
