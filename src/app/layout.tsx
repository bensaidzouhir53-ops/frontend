...
export const metadata: Metadata = {
  ...
  description:
    'نسمة — بيت الأعشاب في السعودية. بخاخات وقطرات عشبية بمعايير صيدلانية لتنظيف الرئتين والجيوب الأنفية. مطابق لمواصفات هيئة الغذاء والدواء (SFDA). توصيل لجميع المناطق والدفع عند الاستلام.',
  keywords: [
    'صيدلية تنفس',
    'بخاخ تنظيف الرئتين',
  ...
  openGraph: {
    ...
    locale: 'ar_SA',
    siteName: 'نسمة',
    title: 'نسمة | بيت الأعشاب في السعودية',
    description:
