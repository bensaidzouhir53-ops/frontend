...
# Easypanel may pass META_PIXEL_ID — always map to NEXT_PUBLIC for browser events.
ARG META_PIXEL_ID=576636091443534
ARG NEXT_PUBLIC_CAPI_ENABLED=true
ENV NEXT_PUBLIC_SITE_URL=$NEXT_PUBLIC_SITE_URL
ENV NEXT_PUBLIC_API_URL=$NEXT_PUBLIC_API_URL
ENV BACKEND_URL=$BACKEND_URL
ENV NEXT_PUBLIC_META_PIXEL_ID=$NEXT_PUBLIC_META_PIXEL_ID
ENV NEXT_PUBLIC_CAPI_ENABLED=$NEXT_PUBLIC_CAPI_ENABLED
